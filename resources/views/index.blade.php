<x-app-layout>
    <div class="filters flex space-x-6">
        ...
        <div class="w-1/3">
            <select name="other_ilters" id="other_ilters" class="w-full rounded-xl px-4 py-2 border-none">
        ...
        <div class="w-2/3 relative">
            ...
            <input type="search" name="search" id="search" placeholder="Find an idea"
